...
public class DarkenView extends BaseView {
    public DarkenView(Context context) {
        super(context);
    }

    public DarkenView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DarkenView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
