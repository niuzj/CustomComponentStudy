...
public class DstInView extends BaseView {
    public DstInView(Context context) {
        super(context);
    }

    public DstInView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DstInView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
