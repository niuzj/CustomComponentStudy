...
public class SrcOutView extends BaseView {
    public SrcOutView(Context context) {
        super(context);
    }

    public SrcOutView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SrcOutView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
